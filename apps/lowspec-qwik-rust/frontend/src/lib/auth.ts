/**
 * ブラウザ側トークン（Access + Refresh）。バックエンドは Cookie セッションも併用可。
 * 認証 API は `POST /api/graphql` の Mutation のみ。
 */
const ACCESS = "lowspec_access_token";
const REFRESH = "lowspec_refresh_token";
