...
export const buttonVariants = cva(
  "group inline-flex items-center justify-center rounded-sm text-sm font-medium transition-all duration-100 focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      look: {
        primary:
          "border border-border bg-primary text-primary-foreground shadow-sm hover:bg-primary/90 active:press active:shadow-base",
        secondary:
          "border border-border bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/90 active:press active:shadow-base",
        alert:
          "border border-border bg-alert text-alert-foreground shadow-sm hover:bg-alert/90 active:press active:shadow-base",
        outline:
          "border border-border bg-background text-foreground shadow-sm hover:bg-accent active:press active:shadow-base",
